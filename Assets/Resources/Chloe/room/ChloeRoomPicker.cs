...
{
    public List<ChloeLabeledRoom> LabeledRooms;

    public override Room createRoom(ExitConstraint requiredExits)
    {
        List<Room> validRooms = new List<Room>();
        foreach (ChloeLabeledRoom labeledRoom in LabeledRooms) {
    ...
    public bool roomMeetsConstraints(ChloeLabeledRoom roomToTest, ExitConstraint requiredExits) {
